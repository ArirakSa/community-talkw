...
urlpatterns = [
    ...
    path('admin/content/delete/<int:pk>/', views.ArticleDeleteView.as_view(), name='content_delete'),
    # 🔹 Thread URLs
    path('comment/<int:thread_id>/', CommentCreateView.as_view(), name='comment_create'),
    path('comment/<int:thread_id>/create/', CreateNotificationView.as_view(), name='create_notification'),
